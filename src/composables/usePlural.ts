...
/**
 * Функция предназначена для работы с множественными формами слов в зависимости от числового значения. Она возвращает правильную форму слова на русском языке, основываясь на количестве. Функция использует стандарт Intl.PluralRules для определения правила склонения.
 *
 * @example
